...
def main(args):
    ...
    with mlflow.start_run():
        ...
        # Converting boolean columns to integers for XGBoost compatibility
        ...
        # Saving locally for development serving
        ...
        # Saving preprocessing artifacts for serving pipeline
